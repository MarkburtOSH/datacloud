...
/****
 * @Author:Markburt
 * @Description:DstNotification构建
 * @Date 2019/6/14 19:13
 *****/
@ApiModel(description = "DstNotification",value = "DstNotification")
@Table(name="dst_notification")
public class DstNotification implements Serializable{
